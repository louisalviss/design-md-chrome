...
## Mission
Reconstruct ${brand} from evidence while keeping observed source facts separate from inference and generic implementation guidance.

## Evidence Classification
- **OBSERVED FROM SOURCE**: extracted computed styles/tokens and source metadata.
- **INFERRED — VERIFY**: audience/product-surface summaries; verify before relying on them.
- **GENERIC GUIDANCE — NOT OBSERVED**: accessibility/state/responsive defaults added by this skill.
